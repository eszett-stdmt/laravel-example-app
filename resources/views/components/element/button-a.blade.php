...
@endphp
<a href="{{ $href }}" class="inline-flex justify-center py-2 px-4 border border-transparent shadow-sm text-sm font-medium rounded-md focus:outline-none focus:ring-offset-2 {{ getThemeClassForButtonA($theme) }}">
    {{ $slot}}
</a>